...
<body>
    <div class="invoice-container">
        ...
        <table class="info-section">
            <tr>
                ...
                <td class="info-box">
                    ...
                    <p><strong>Paid amount:</strong> {{ $sale->paid_amount }} </p>
                    <p><strong>Due amount:</strong> {{ $sale->due_amount }} </p>
                    <p><strong>Grand Total:</strong> {{ number_format($sale->grand_total) }} </p>
                </td>
            </tr>
        </table>
        ...
        <table class="summary-table">
            <tr>
                <td><strong>Total Discount:</strong> ${{ number_format($sale->discount, 2) }} </td>
            </tr>
            <tr>
                <td><strong>Shipping Cost:</strong> ${{ number_format($sale->shipping, 2) }} </td>
            </tr>
            <tr>
                <td><strong>Grand Total:</strong> ${{ number_format($sale->grand_total, 2) }} </td>
            </tr>
        </table>
    </div>
</body>
